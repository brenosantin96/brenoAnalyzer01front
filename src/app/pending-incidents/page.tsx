                    ...
                    {allPendingTickets.length === 0 &&
                        <div className='mx-5 text-center w-full h-3/4 flex flex-col justify-center items-center'>
                            ...
                            <p className='text-2xl justify-center items-center mt-5 text-red-500'>
                                El fichero debe contener las columnas 'Número', 'Abierto', 'Actualizado', 'Asignado a', 'Motivo para poner en espera', 'Etiquetas'
                            </p>
                            <p className='text-2xl justify-center items-center mt-5'>
                                El fichero se puede coger desde el siguiente enlace:  <strong><Link target='_blank' className='hover:text-[#006989]' href="https://repsolprod.service-now.com/incident_list.do?sysparm_query=assignment_group%3D0231c292db67ba00b5e3fd651d9619fc%5Estate%3D3%5Eactive%3Dtrue">Hacer clic aquí</Link></strong>
                            </p>
                        </div>
                    }
