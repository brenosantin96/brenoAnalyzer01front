...
const DropAreaButtonAreaMainPage = () => {
    ...
    <div className='h-screen flex justify-center items-center bg-[#A3BAC3] overflow-auto' onDragOver={handleDragOver}>
      ...
      <div className='container h-screen mx-auto overflow-auto'>
        <div className='flex flex-col justify-center items-center h-screen'>
          <h1 className='text-3xl mb-12 md:text-4xl font-inter font-bold p-3 text-center text-white '>Importe el fichero excel para empezar el análisis</h1>
...
export default DropAreaButtonAreaMainPage